...
const app = express();
const getClientInformationRoute = require("../routes/getClientInformation");
const { clientInformation } = require("../models/clientInformation.js");

app.use(express.json());
app.use("/", getClientInformationRoute);

describe("POST /api/getClientInformation", () => {
  ...
  describe("given a user that has clientinformation in the database", () => {
    ...
    it("should return the clientinformation for the user", async () => {
